...
export class RendererManager {
  ...
  constructor(canvasRef: HTMLDivElement, gameRefs: GameRefs) {
    ...
    if (
      ...
      !this.gameRefs.renderer
    ) {
      console.error(
        "RendererManager: Core Three.js objects not found in gameRefs. Ensure ThreeSetup runs first."
      );
      return;
    }
