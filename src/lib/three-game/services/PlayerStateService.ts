...
export class PlayerStateService {
  ...
  public readonly runSpeedMultiplier: number =
    CONTROL_CONFIG.RUN_SPEED_MULTIPLIER;
  public readonly boostSpeedMultiplier: number =
    CONTROL_CONFIG.BOOST_SPEED_MULTIPLIER;
  ...
  public toggleFlying(): void {
    ...
    if (
      now - this._lastSpacePressTime < this.flyToggleDelay &&
